...
[PLACEHOLDER: Demo video — screen recording of the full Demo Replay run (shield → decrypt → reconcile → receipt → on-chain proof verify) plus the failure-path retry, ~90 seconds]
